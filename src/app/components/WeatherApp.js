...
const Api_Key = "6bc8e1a4f8d9749421affe0ebfcb11e9"
    ...
    return(
        <div className="bg-gray-300 h-screen grid place-items-center">
            <div className="bg-white w-96 p-4 rounded-md shadow-lg">
                ...
                <input type="text" ref={inputRef} placeholder="Sua localização" className="text-x1 border-b 
                p-1 border-gray-200 font-semibold uppercase flex-1"/>
                <button onClick={fetchWeather}>
                    <img src="https://cdn-icons-png.flaticon.com/512/758/758651.png" className="w-8"/>
                </button>
                </div>
                ...
                {loading ? (
                  ...
                  showWeather && (
                    <div className="text-center flex flex-col gap-6 mt-10">
                      {apiData && (<p className="text-xl font-semibold">
